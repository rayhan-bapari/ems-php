        ...
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <div class="plus-box">
                    ...
                    <a class="text-white fs-14" href="analytics.html">Learn more</a>
                </div>
                <div class="copyright">
                    <p><strong>Ventic Ticketing Dashboard</strong> © 2023 All Rights Reserved</p>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="event-img">
                                            <img src="images/card/pic6.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer pt-2 border-0">
                                        <a href="javascript:void(0);" class="btn btn-secondary d-block text-white dz-load-more" id="RecentList" rel="ajax/recent-list.html">Load More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-sm-6 mt-3">
                                ...
                                <div id="sync1" class="owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic7.jpg" alt="">
                                    ...
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic8.jpg" alt="">
                                            <div class="event-card-overlay">
                                    ...
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic9.jpg" alt="">
                                            <div class="event-card-overlay">
                                    ...
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic10.jpg" alt="">
                                            <div class="event-card-overlay">
                                    ...
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic11.jpg" alt="">
                                            <div class="event-card-overlay">
                                    ...
                                    <div class="item">
                                        <div class="event-card">
                                            <img src="images/events/pic12.jpg" alt="">
                                            <div class="event-card-overlay">
                                                <h5>Communication</h5>
                                            </div>
                                        </div>
                                ...
                                <div id="sync2" class="owl-carousel owl-theme gallery-slider">
                                    <div class="item">
                                        <img src="images/events/pic1.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="images/events/pic2.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="images/events/pic3.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="images/events/pic4.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="images/events/pic5.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="images/events/pic6.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Video Conference Form</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Lee">
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="mb-3">
